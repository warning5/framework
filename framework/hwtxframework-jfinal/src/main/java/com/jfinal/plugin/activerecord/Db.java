...
public class Db {
    ...
    static Page1<Record> paginateOverOffset(Config config, Connection conn, int offset, int number, String select, String sqlExceptSelect,
        ...
        if (size == 1)
            ...
            return new Page1<Record>(new ArrayList<Record>(0), 0);
        ...
        return new Page1<Record>(list, (int) totalRow);
    }

    public static Page1<Record> paginateOverOffset(int offset, int number, String select, String sqlExceptSelect, Object... paras) {
        Connection conn = null;
        try {
            conn = DbKit.config.getConnection();
            return paginateOverOffset(DbKit.config, conn, offset, number, select, sqlExceptSelect, paras);
        } catch (Exception e) {
    ...
    public static Page1<Record> paginateOverOffset(int offset, int number, String select, String sqlExceptSelect) {
        return paginateOverOffset(offset, number, select, sqlExceptSelect);
    }
